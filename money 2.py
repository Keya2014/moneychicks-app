...
st.markdown(
    """
    <style>
        .main { background-color: #f8f6f9; }
        .big-title { font-size: 2.8em; font-weight: bold; color: #a54cb7; }
        .section-title { font-size: 1.5em; color: #a54cb7; }
        .mission { background: #fff3fc; border-radius: 10px; padding: 1em; }
        .manifesto { background: #f3f9ff; border-radius: 10px; padding: 1em; }
        .community { background: #f9fff3; border-radius: 10px; padding: 1em; }
        .calculator { background: #ffffff; border-radius: 10px; padding: 1em; box-shadow: 0 2px 8px #eee; }
        a.ig-link {
            display: inline-flex;
            align-items: center;
...
st.markdown(
    ...
    Financial Learning is the foundation of women empowerment. We’ve made it our mission to give you an unparalleled learning ground. Where all questions are safe, because when those are out in the open, that’s when you give your future a chance to be safe.

    **Financial Literacy gives you the freedom to walk out on relationships and jobs that you don’t need. You choose because you can.**
    """,
    unsafe_allow_html=True,
)

# --- Community section moved last ---
st.markdown(
    """
    <div class="community">
